<?php
  ...
  if(isset($_POST['Name'])){
    ...
    $sql="INSERT INTO `department` ( `DeptName`, `BuildingName`, `Budget`) VALUES ('$Name', '$Building', '$Budget');";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Add Department Form</h2>
                        <form method="POST" class="register-form" id="register-form" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Building" id="Building" placeholder="Building name"/>
                            </div>
                            <div class="form-group">
                                <label for="ID-Proof"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="number" name="Budget" id="Budget" placeholder="Department Budget"/>
                            </div>
