<?php
  ...
  if(isset($_POST['ID'])){
    ...
    $sql="INSERT INTO `student` ( `ID`, `Name`, `DeptName`,`Credits`) VALUES ('$ID', '$Name', '$Dept','$Credits');";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Add Student Form</h2>
                        <form method="POST" class="register-form" id="register-form" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dept" id="dept" placeholder="Department Name"/>
                            </div>
                            <div class="form-group">
