<?php
  ...
  if(isset($_POST['Section'])){
    ...
    $sql="INSERT INTO `section` ( `Section`, `Sem`,`Year`,`Building`) VALUES ('$Section', '$Sem','$Year','$Building');";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Add Section Form</h2>
                        <form method="POST" class="register-form" id="register-form" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
                            <div class="form-group">
                                ...
                                <input type="text" name="Section" id="Section" placeholder="Section ID"/>
                            </div>
                            <div class="form-group">
